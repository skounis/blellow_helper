...
namespace Drupal\blellow_helper\Plugin\PageHeaderMetadata\Model;
...
class FutCurrentEntities {
  ...
  /**
   * The primary entity.
   * @return \Drupal\blellow_helper\Plugin\PageHeaderMetadata\Drupal\Core\Entity\EntityInterface|mixed
   */
