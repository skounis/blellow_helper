...
namespace Drupal\blellow_helper\ContextProvider;
...
use Drupal\blellow_helper\PageHeaderMetadataPluginManager;
...
class PageHeaderContext implements ContextProviderInterface {
   ...
   *
   * @var \Drupal\blellow_helper\PageHeaderMetadataPluginManager
   */
   ...
   *
   * @param \Drupal\blellow_helper\PageHeaderMetadataPluginManager $metadata_plugin_manager
